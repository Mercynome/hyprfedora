...
if [ "$OS" == "fedora" ]; then
    ...
    sudo pacman -Syu --needed hyprland kitty fuzzel waybar wlogout kvantum qt5ct qt6ct cliphist wl-clipboard pyprland hypridle hyprlock cargo wget tar xz zsh unzip cava btop rofi swww qt6-wayland qt6-declarative qt6-svg qt6-5compat
